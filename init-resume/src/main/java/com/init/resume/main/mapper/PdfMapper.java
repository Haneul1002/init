...
public interface PdfMapper {
    ...
    List<QualificationVO> qualifiSelect(String info_id) throws Exception;
    ...
    CareerVO careerDay(String member_id) throws Exception;
    
    WorkVO workDay(String member_id) throws Exception;
}
